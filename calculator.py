...
btEqual = Button(gui, text = "=", height = 7, command = lambda: evaluate(equation))
...
btPlus.place(x = 200, y = 50)
btMinus.place(x = 200, y = 120)
btMultiplication.place(x = 200, y = 190)
btDivision.place(x = 200, y = 260)

btEqual.place(x = 300, y = 50)
